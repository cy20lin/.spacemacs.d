  ...
  (unless company-clang-arguments
    (let* ((cc-file (spacemacs/company-find-clang-complete-file))
           ...
           (isystem-paths (spacemacs//filter-and-substring flags
                                                           "-isystem" 8))
           (idirafter-paths (spacemacs//filter-and-substring flags "-idirafter" 10))
      ...
      (setq-local flycheck-clang-language-standard (my-c-c++-cdb-guess-clang-standard)) ;; ++
      (setq-local flycheck-gcc-language-standard (my-c-c++-cdb-guess-gcc-standard)) ;; ++
