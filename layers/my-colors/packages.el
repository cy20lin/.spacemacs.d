...
(defun my-colors/init-nyan-mode ()
  (use-package nyan-mode
    :if my-colors-enable-nyan-cat-progress-bar
    :config
    (progn
...
(defun my-colors/init-color-identifiers-mode ()
  (use-package color-identifiers-mode
    :commands color-identifiers-mode
    :defer t
    :init
    (progn
      (when (eq 'variables my-colors-colorize-identifiers)
...
(defun my-colors/init-rainbow-identifiers ()
  (use-package rainbow-identifiers
    ...
    (progn
      ...
      (defadvice spacemacs/post-theme-init (after my-colors/post-theme-init activate)
        "Adjust lightness and brightness of rainbow-identifiers on post theme init."
        (my-colors//tweak-theme-colors spacemacs--cur-theme))
      ;; key bindings
      (spacemacs/declare-prefix "Ci" "colors-identifiers")
      ...
      (with-eval-after-load 'rainbow-identifiers
        (define-global-minor-mode global-rainbow-identifiers-mode
          rainbow-identifiers-mode my-colors//rainbow-identifiers-mode-maybe))
      (spacemacs|add-toggle global-rainbow-identifiers-mode
        ...
        :evil-leader "tC C-a")
      (spacemacs/set-leader-keys "Cis" 'my-colors/start-change-color-saturation)
      (spacemacs/set-leader-keys "Cil" 'my-colors/start-change-color-lightness)
      ;; tweak colors of current theme
      (my-colors//tweak-theme-colors spacemacs--cur-theme)
      (when (eq 'all my-colors-colorize-identifiers)
        (global-rainbow-identifiers-mode)))))
