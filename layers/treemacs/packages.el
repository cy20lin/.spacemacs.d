...
(defconst treemacs-packages
  '(golden-ratio
    (treemacs :location (recipe
                         :fetcher github
                         :repo "Alexander-Miller/treemacs"
                         :commit "e8be02971ad6c7a9c33ec544fa41b4b2f6827a35" ;; version 1.18.1
                         :files (:defaults
                                 "icons"
    ...
    (treemacs-projectile :toggle (memq dotspacemacs-editing-style '(vim hybrid))
                   :location
                   (recipe
                    :fetcher github
                    :repo "Alexander-Miller/treemacs"
